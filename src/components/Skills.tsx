...
const skills = [
  { name: "HTML/CSS", level: 80, icon: <FaHtml5 className="text-orange-500" /> },
  { name: "JavaScript", level: 00, icon: <FaJs className="text-yellow-400" /> },
  { name: "React", level: 00, icon: <FaReact className="text-cyan-400" /> },
  { name: "TypeScript", level: 01, icon: <SiTypescript className="text-blue-600" /> },
  { name: "Node.js", level: 01, icon: <FaNodeJs className="text-green-500" /> },
  { name: "Tailwind CSS", level: 01, icon: <SiTailwindcss className="text-sky-400" /> },
